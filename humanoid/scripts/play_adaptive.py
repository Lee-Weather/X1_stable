...
# Features:
#   - Stepped speed commands (0.2 -> 0 -> -0.2 -> 0 -> 0.2 -> 0 m/s) so the
#     rapid decel/accel transitions and the in-place stepping are directly
#     visible in the video and measurable from the CSV.
#   - Overlays on the recorded video: command/actual/average speed, per-foot
#     contact state (ON/OFF + force), and the gait cycle time.
